                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        title="Inactivar" data-bs-target="#confirmationDestroy-{{$unit->id}}"><i class="fa fa-fw fa-trash"></i></button>
                                                        @else
                                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"  tooltip="tooltip"
                                                        title="Activar" data-bs-target="#confirmationDestroy-{{$unit->id}}"><i class="fa-solid fa-rotate"></i></button>
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
