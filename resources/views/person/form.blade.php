                                        ...
                                        <div class="card-body">
                                            <div class="row row-cards">
                                                ...
                                                <div class="col-sm-6 md-6">
                                                    <div class="md-3" style="margin-bottom: 16px">
                                                        ...
                                                        {!! $errors->first(
                                                            'identification_type',
                                                            '<div class="invalid-feedback">El campo de tipo de identificación es obligatorio</div>',
                                                        ) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 md-6">
                                                    <div class="mb-3">
                                                        <label for="identification_number" class="form-label"
                                                            id="identification_number" style="font-weight: bolder">
                                                ...
                                                <div class="col-sm-6 md-6">
                                                    <div class="mb-3">
                                                        <label for="digit_verification" id="digit_verification"
                                                            class="form-label" style="font-weight: bolder">
                                                        ...
                                                        {!! $errors->first(
                                                            'digit_verification',
                                                            '<div class="invalid-feedback">El campo dígito de verificación es obligatorio</div>',
                                                        ) !!}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 md-6" id="box-comercial-name">
                                                    <div class="mb-3">
                                                        <label for="comercial_name" class="form-label"
                                                            style="font-weight: bolder">
                                                            {{ __('Nombre comercial') }}
                                                        </label>
                                                        ...
                                                        {!! $errors->first(
                                                            'comercial_name',
                                                            '<div class="invalid-feedback">El campo nombre comercial es obligatorio</div>',
                                                        ) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row row-cards">
                                                ...
                                                <div class="col-sm-6 md-6" id="box-second-surname">
                                                    <div class="mb-3">
                                                        <label for="second_surname" class="form-label"
                                                            style="font-weight: bolder">
                                                            {{ __('Segundo Apellido') }}
                                                        </label>
                                                        ...
                                                        {!! $errors->first(
                                                            'second_surname',
                                                            '<div class="invalid-feedback">El campo segundo apellido es obligatorio</div>',
                                                        ) !!}
                                                    </div>
                                                </div>
                                                {{--  Ciudad  --}}
