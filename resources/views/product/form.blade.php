                                        ...
                                        <div class="card card-default">
                                            ...
                                            <div class="card-body">
                                                <div class="row row-cards">
                                                    ...
                                                    <div class="col-sm-6 col-md-6" style="margin-bottom: 16px">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="classification_tax"
                                                                style="font-weight: bolder">
                                                    ...
                                                    <div class="col-sm-6 col-md-6" style="margin-bottom: 16px">
                                                        <label class="form-label" for="factory_reference"
                                                            style="font-weight: bolder">
                                            ...
                                            <div class="card-footer text-end">
                                                <a class="btn btn btn-primary" style="120px"
                                                    href="{{ route('products.index') }}">Regresar</a>
                                                <button class="btn btn btn-success" style="120px"
