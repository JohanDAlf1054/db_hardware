                    ...
                    <div class="card-body">
                        <div class="row border border-light p-2 mb-3 d-flex align-items-start">
                                    ...
                                    <div class="form-group d-flex align-items-center">
                                        <div class="d-flex flex-column flex-grow-1 mr-2 mb-2">
                                            <label for="product_id"
                                                class="form-label @error('product_id') is-invalid @enderror"
                                                style="font-weight: bolder">Producto</label>
                                    ...
                                    <div class="form-group d-flex align-items-center">
                                        <div class=" col-md-6 d-flex flex-column flex-grow-1 mr-2 px-1 ">
                                            <label for="fecha_inicio"
                                                class="form-label @error('fecha_inicio') is-invalid @enderror"
                                        ...
                                        <div class=" col-md-6 d-flex flex-column flex-grow-1 mr-2">
                                            <label for="fecha_cierre"
                                                class="form-label @error('fecha_cierre') is-invalid @enderror"
                                                style="font-weight: bolder">
                                                Fecha de cierre
                                            </label>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group d-flex align-items-center">
                                    <div class="d-flex flex-column flex-grow-1 mr-2 mb-2">
                                        <label for="categoria" class="form-label" style="font-weight: bolder">Categoría Del
                                            Producto</label>
                                ...
                                <div class="form-group d-flex align-items-center">
                                    <div class="d-flex flex-column flex-grow-1 mr-2 mb-2">
                                        <label for="subcategoria" class="form-label"
                                            style="font-weight: bolder">Estado</label>
                        ...
                        <div class="table_container">
                            <div>
                                <table class="table table-striped table-hover" style="justify-content: center; width: 100%"
                                    id="datatable">
                                    ...
                                    <tbody>
                                        @foreach ($sales as $ventas)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ${{ number_format($ventas->total_value, 2) }}
                                                </td>
                                                <td style="text-align: center">
                                                ...
                                                <td style="text-align: center">
                                                    {{ number_format($ventas->product_tax, 2, '.', ',') }}%
                                                </td>
                                                <td style="text-align: center">
                                                    ${{ number_format($ventas->net_total, 2) }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
