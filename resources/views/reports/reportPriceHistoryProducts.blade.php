                            ...
                            <table class="table table-striped table-hover" style="justify-content: center; width: 100%" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">{{ $ventas->created_at->format('d/m/Y') }}</td>
                                        <td style="text-align: center">
                                            {{$ventas->amount}}
                                        </td>
                                        <td style="text-align: center">
                                            {{$ventas->venta->gross_totals }}
                                        </td>
                                        <td style="text-align: center">
                                            {{$ventas->discounts }}
                                        </td>
                                        <td style="text-align: center">{{($ventas->amount) * ($ventas->selling_price) - ($ventas->discounts)}}</td>
                                        <td style="text-align: center">{{ $ventas->tax }}</td>
                                        <td style="text-align: center">{{ $ventas->venta->net_total }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
